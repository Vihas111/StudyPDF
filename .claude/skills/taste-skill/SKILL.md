---
name: taste-skill
description: Anti-slop frontend design taste rules for landing pages, portfolios, and marketing-site redesigns (React/Next.js/Tailwind). Not for dashboards, data tables, or multi-step product UI. Source: https://www.tasteskill.dev/ (Leonxlnx/taste-skill).
---
